# Исправляем код интеграции с Inspiro
inspiro_integration_fixed = '''
import requests
import pandas as pd
import json
import numpy as np
...
# Сохраняем исправленную интеграцию
with open('inspiro_integration.py', 'w', encoding='utf-8') as f:
    f.write(inspiro_integration_fixed)

print("Файл inspiro_integration.py создан (исправленная версия)")