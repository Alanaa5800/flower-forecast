...
# Сохраняем систему обработки ошибок
with open('error_handling_system.py', 'w', encoding='utf-8') as f:
    f.write(error_handling_system)

print("Файл error_handling_system.py создан")